...
class ProductMapper(val data: GetProductsQuery.Data) {
    ...
    private fun dataToProduct(product: GetProductsQuery.Product): Product {
        var photo = Product.Photo("https://cdn.filesrvcloud.ir/v1/AUTH_4a3e3bbd118c41b48238766e82ca5e4a/mc/20a549f6a9659df844671ce1b5221ecb4295d7df.png?temp_url_sig=e376cbbf5d745690d3f59adc3fb974cfffd20c84&temp_url_expires=4099667400&extra")
